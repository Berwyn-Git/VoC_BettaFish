"""
Streamlit Web界面
为Compete Agent（竞争分析）提供友好的Web界面
"""
...
from CompeteEngine import DeepSearchAgent, Settings
...
def main():
    """主函数"""
    st.set_page_config(
        page_title="竞争分析Agent",
        page_icon="",
        layout="wide"
    )

    st.title("竞争分析Agent")
    st.markdown("专业的竞争分析AI代理")
    st.markdown("广度爬取官方报道与新闻，注重国内外资源相结合，深度分析竞争态势和竞争策略")
