"""
Unified OpenAI-compatible LLM client for the Compete Engine (竞争分析), with retry support.
"""
...
class LLMClient:
    ...
    def __init__(self, api_key: str, model_name: str, base_url: Optional[str] = None):
        if not api_key:
            raise ValueError("Compete Engine (竞争分析) COMPETE_ENGINE_API_KEY is required.")
        if not model_name:
            raise ValueError("Compete Engine (竞争分析) COMPETE_ENGINE_MODEL_NAME is required.")
